...
// categoría elegida — se limpia automáticamente si el usuario cambia de categoría. Unidad de medida
// ya no es exclusiva de FISICO desde v1.6.0 (RESPUESTA-007) — se muestra siempre, filtrada por
// `tipo` del producto. Los campos que sí siguen exclusivos de FISICO se ocultan por completo cuando
// `tipo=SERVICIO` (nunca deshabilitados).
